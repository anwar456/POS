   <!--main content end-->
      ...
      <footer class="site-footer">
          <div class="text-center">
              ...
              <?php echo date('Y');?> - Sistem Penjualan Barang Berbasis Web | Template
              By <a href="https://usebootstrap.com/theme/dashgumbasic" style="color:yellow;font-weight:700;" target="_blank">Dashgum</a>
              <a href="#" class="go-top">
